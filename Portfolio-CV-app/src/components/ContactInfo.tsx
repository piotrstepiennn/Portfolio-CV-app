...
const ContactInfo = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="container border border-2 rounded-pill p-1 w-50"
      ...
      >
        <div className="d-flex align-items-center justify-content-center p-1">
          ...
          <a
            ...
            className="justify-content-center d-flex link-secondary text-black ms-1 mb-1"
          >
